module.exports = function() {
  ...
  function parser_delimiter(newDelimiter) {
    ...
    if (buffer != null) throw new Error("cannot change delimiter after filling data");
  ...
  function parser_encoding(newEncoding) {
    ...
    if (buffer != null) throw new Error("cannot change encoding after filling data");
  ...
  function parser_fill(data) {
    if (bufferOffset < bufferLength) throw new Error("cannot fill before all lines are read");
  ...
  function parser_read(allowPartial) {
    var token;
