...
module.exports = function() {
  var r = reader(pipe_open, reader_read, pipe_close),
      w = writer(pipe_open, writer_write, pipe_close),
      pipe = {
        fill: r.fill,
        read: r.read,
        drain: w.drain,
  ...
  function pipe_close(channel, callback) {
    process.nextTick(callback.bind(null, null));
  }
