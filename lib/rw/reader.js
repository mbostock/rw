module.exports = function(open, read, close) {
  ...
  function reader_fill(callback) {
    ...
    if (channel == null) return fillCallback = callback, void reader_open();
    if (bufferAvailable >= bufferLength) return void process.nextTick(callback.bind(null, null));
    ...
    read(channel, buffer, bufferAvailable, bufferLength - bufferAvailable, function(newError, readLength) {
      ...
      if (!readLength) return reader.ended = true, void close(channel, callback);
