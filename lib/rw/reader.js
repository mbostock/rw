module.exports = function(open, read, close) {
  ...
  function reader_fill(callback) {
    ...
    // Refill the buffer. If no bytes are read, the channel has ended.
    read(channel, buffer, reader.available, bufferLength - reader.available, function(error_, readLength) {
